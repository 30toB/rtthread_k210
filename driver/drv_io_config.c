...
{
#ifdef BSP_USING_LED
    IOCONFIG(BSP_LED1_PIN, HS_GPIO(LED_1_PIN)),          /* LED  PIN */
    IOCONFIG(BSP_LED2_PIN, HS_GPIO(LED_2_PIN)),          /* LED  PIN */
    IOCONFIG(BSP_LED3_PIN, HS_GPIO(LED_3_PIN)),          /* LED  PIN */
#endif
    ...
    IOCONFIG(BSP_LCD_WR_PIN, FUNC_SPI0_SCLK),                /* LCD WR PIN */
    IOCONFIG(BSP_LCD_DC_PIN, HS_GPIO(LCD_DC_PIN)),           /* LCD DC PIN */
    IOCONFIG(BSP_LCD_RST_PIN, HS_GPIO(LCD_RST_PIN)),         /* LCD DC PIN */
#endif
...
#if defined(BSP_USING_CAMERA) || defined(BSP_USING_LCD) || defined(BSP_USING_LCD_ILI9341)
